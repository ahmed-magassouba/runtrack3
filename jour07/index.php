    ...
    <main>
            ...
            <div class="row gx-5">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Votre achat a bien été enregistrer
                                        </div>
                ...
                <div class="col-7 primary ">
                    <div id="jumbotron" class="jumbotron" m-5>
                        ...
                        <hr class="my-4">
                        <p id="jumbo">Le sens étendu désigne l'univers dans son ensemble.</p>
        ...
        <div class="row">
            ...
            <div class="offset-2 col-8">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-bar-left text-end" viewBox="0 0 16 16">
